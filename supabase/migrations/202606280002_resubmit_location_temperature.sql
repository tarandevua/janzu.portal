drop function if exists public.resubmit_rejected_location(
  uuid,
  uuid,
  text,
...
create or replace function public.resubmit_rejected_location(
  ...
  target_temperature_value numeric,
  target_temperature_unit text,
...
begin
  ...
  set name = target_name,
      ...
      temperature_value = target_temperature_value,
      temperature_unit = target_temperature_unit,
