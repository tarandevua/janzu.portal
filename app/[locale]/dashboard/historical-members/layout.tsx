...
export default async function HistoricalMembersLayout({
  children,
  params,
}: {
  children: ReactNode;
  ...
  return (
    <JanzuDashboardFrame
      ...
      title={dictionary.historicalMembers.title}
      user={{
        id: data.user.id,
        name: data.user.user_metadata.full_name ?? data.user.email ?? "Janzu",
